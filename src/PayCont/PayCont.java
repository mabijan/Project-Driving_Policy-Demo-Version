...
public class PayCont {
    ...
    public PayCont(String cardNum, String CVV2, String EXPyear, String EXPmonth, String secondPass, String DName) {
        CardNum = cardNum;
        this.CVV2 = CVV2;
    ...
    public Boolean PayCont() {
        ...
        for (int i = 0;i < 3;i++) {
            ...
            if (Character.isDigit(CVV2.charAt(i)) == false && CVV2.length() != 3) { key3 = false; }
